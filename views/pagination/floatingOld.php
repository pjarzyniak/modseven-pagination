...
<div class="c pagination-out">
    <div style="padding-top: 5px;"><?=__('Found:');?> <?php echo $page->total_items; ?></div>
    ...
    <ul class="pagination">
        <?php if ($first_page !== FALSE): ?>
            <li class="page-item"><a href="<?php echo strtolower(HTML::chars($page->url($first_page))) ?>" rel="first" class="page-link">&laquo;</a></li>
        <?php else: ?>
        ...
        <?php foreach ($links as $number => $content): ?>
            ...
            <?php if ($number === $current_page): ?>
                <li class="page-item active"><span class="page-link"><?php echo $number; ?> <span class="sr-only">(current)</span></span></li>
            <?php else: ?>
                <li class="page-item"><a class="page-link" href="<?php echo strtolower(HTML::chars($page->url($number))) ?>"><?php echo $content ?></a></li>
            <?php endif ?>

        <?php endforeach ?>

        <?php if ($last_page !== FALSE): ?>
            <li class="page-item"><a class="page-link" href="<?php echo strtolower(HTML::chars($page->url($last_page))) ?>" rel="last">&raquo;</a></li>
        <?php else: ?>
